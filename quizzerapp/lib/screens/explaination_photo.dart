...
import 'package:quizzerapp/screens/explaination_video.dart';
...
class PhotoExplaination extends StatefulWidget{
    const PhotoExplaination({super.key});

    @override
    State<PhotoExplaination> createState() => _PhotoExplainationState();
}

class _PhotoExplainationState extends State<PhotoExplaination>{
            ...
            body: Container(
                ...
                child: Padding(
                    ...
                    child: Column(
                        ...
                        children:[
                                CustomAppBar(title: PHOTO_EXPLANATION),
                                ...
                                Center(
                                    child:Container(
                                        ...
                                        decoration: BoxDecoration(
                                            image: DecorationImage(image: AssetImage('assets/images/photo_bk.png'), fit: BoxFit.fill),
                                            boxShadow: [
                                                BoxShadow(
                                ...
                                SubmitButton(
                                    ...
                                    onTap: () {
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                                builder: (context) => VideoExplaination(),
                                            ));
                                    },
                                ),
                        ]
