...
import 'package:quizzerapp/screens/explaination_photo.dart';
...
class TextExplaination extends StatefulWidget{
    const TextExplaination({super.key});

    @override
    State<TextExplaination> createState() => _TextExplainationState();
}

class _TextExplainationState extends State<TextExplaination>{
            ...
            body: Container(
                ...
                child: Padding(
                    ...
                    child: Column(
                        ...
                        children:[
                                CustomAppBar(title: TEXT_EXPLANATION),
                                ...
                                ExplainText(height: 126.h, explaination: "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout"),
                                ...
                                SubmitButton(
                                    ...
                                    onTap: () {
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                            builder: (context) => PhotoExplaination(),
                                            ));
                                    },
                                ),
                        ]
